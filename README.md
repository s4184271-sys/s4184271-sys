...
| Area | Skills |
| --- | --- |
| Data Analytics | Data Cleaning, EDA, Data Transformation, Insight Generation |
| SQL | PostgreSQL, Joins, Aggregations, GROUP BY, HAVING, Window Functions |
| Excel | PivotTables, PivotCharts, Power Query, Power Pivot, DAX, VBA |
...
An interactive hospital emergency room dashboard built from approximately 9,200 patient admission records.

- Cleaned and transformed raw data using Power Query
- Structured the data model using Power Pivot
- Used DAX logic for wait-time and satisfaction analysis
- Created KPI cards, trends, department analysis, and interactive slicers
- Designed the dashboard as a hospital operations reporting tool
...
- Cleaned and merged multiple raw tables using Python and Pandas
- Engineered delivery and customer-related metrics
...
A SQL-based hospital analytics project focused on querying and analyzing hospital data.

- Analyzed patient volumes and hospital expenses
- Calculated average length of stay by department
- Compared patient volumes across cities
- Analyzed monthly medical expenses
- Practiced aggregation, grouping, date calculations, and ranking queries

[View Project](https://github.com/s4184271-sys/hospital-sql-analytics)

### 6. Sales Performance Dashboard with VBA
**Excel | PivotTables | PivotCharts | VBA**

An interactive sales dashboard designed to monitor sales performance against targets.

- Built PivotTables and PivotCharts for sales analysis
- Added region-based filtering through slicers
- Used VBA to manage slicer connections
- Added dynamic visual feedback for selected regions
- Calculated Target Hit % and Away From Target %

[View Project](https://github.com/s4184271-sys/sales-performance-dashboard)

### 7. OIBSIP Data Analytics Projects
**Python | Pandas | Matplotlib | Seaborn | Scikit-learn**

A collection of analytics and machine learning projects completed during the Oasis Infobyte Data Analytics internship.
...
[View Repository](https://github.com/s4184271-sys/OIBSIP)
...
**LinkedIn:**  
https://www.linkedin.com/in/syed-mohammed-ghouse-64ab31372/

**GitHub:**  
https://github.com/s4184271-sys

---

*This profile is a work in progress as I continue learning, building projects, and expanding my analytical skills.*
